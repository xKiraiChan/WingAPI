...
namespace WingAPI
{
    public static class Controller
    {
        ...
        internal static IEnumerator FindUI()
        {
            ...
            Left.WingOpen.GetComponent<UnityEngine.UI.Button>().On(new Action(() => Init_L?.Invoke()));
            Right.WingOpen.GetComponent<UnityEngine.UI.Button>().On(new Action(() => Init_R?.Invoke()));
        }
